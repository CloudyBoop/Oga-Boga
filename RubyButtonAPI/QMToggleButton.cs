...
namespace RubyButtonAPI
{
    public class QMToggleButton : QMButtonBase
    {
        ...
        private IEnumerator WaitForTabMenu(int btnXLocation, int btnYLocation, string btnTextOn, Action btnActionOn, string btnTextOff, Action btnActionOff, string btnToolTip, Color? btnBackgroundColor, Color? btnTextColor, bool shouldSaveInConfig, bool defaultPosition)
        {

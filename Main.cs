...
namespace Oga_Boga
{
    ...
    public class Main : MelonLoader.MelonMod
    {
        ...
        public override void OnApplicationStart()
        {
            ...
            Console.ResetColor();
            HarmonyInstance harmonyInstance = HarmonyInstance.Create("♥");
            harmonyInstance.Patch(typeof(Photon.Realtime.LoadBalancingClient).GetMethod("Method_Public_Virtual_New_Boolean_Byte_Object_RaiseEventOptions_SendOptions_0"), GetPatch("oof"));
        }
